...
public class MpGenerator {
    ...
    //config
    private static final String FILE_OUT_PATH = MpGenerator.class.getResource("").getPath().replace( "target/test-classes/com/bestbigkk/generation", "src/test/java/dist");
    private static final String AUTHOR = "xugongkai";
    //db
    private static final String DB_TYPE = "com.mysql.cj.jdbc.Driver";
    public static final String DB_URL = "jdbc:mysql://cdb-41wrstjc.bj.tencentcdb.com:10187/xugongkai_test?useSSL=true&autoReconnect=true&serverTimezone=Asia/Shanghai";
    ...
    public static final String[] DB_TARGET_TABLE_NAME = {"t_user"};
    ...
    public void generator() {
        ...
        pc.setController("enums.controller");
